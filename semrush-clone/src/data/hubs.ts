...
export const hubs: Record<string, HubPageData> = {
  ...
  vs: {
    eyebrow: "COMPARE",
    title: "Compare Semrush",
    subtitle: "See how Semrush stacks up against other tools across features and data.",
    cards: [
      { title: "Semrush vs Moz", body: "Compare features, data coverage, and pricing.", href: "/vs/semrush-vs-moz/", tag: "Compare" },
      { title: "Semrush vs Ahrefs", body: "Compare features, data coverage, and pricing.", href: "/vs/semrush-vs-ahrefs/", tag: "Compare" },
    ],
  },
  "website-top": {
  ...
  integrations: {
    eyebrow: "PLATFORM",
    title: "Integrations",
    subtitle: "Connect Semrush with the tools your team already uses.",
