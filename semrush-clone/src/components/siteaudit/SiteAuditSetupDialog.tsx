...
const COPY = {
  ko: {
    ...
    scheduleWeekly: "매주",
    scheduleWeeklyHint: "매주 정기적으로 크롤링합니다. (자동 실행은 추후 제공)",
    scheduleMonthly: "매월",
    scheduleMonthlyHint: "매월 정기적으로 크롤링합니다. (자동 실행은 추후 제공)",
    cancel: "취소",
  ...
  en: {
    ...
    scheduleWeeklyHint: "Repeats every week. (automatic runs coming soon)",
    scheduleMonthly: "Monthly",
    scheduleMonthlyHint: "Repeats every month. (automatic runs coming soon)",
    cancel: "Cancel",
    start: "Start Site Audit",
    starting: "Saving…",
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <RadioCard
                  ...
                  label={copy.scheduleMonthly}
                  hint={copy.scheduleMonthlyHint}
                />
              </div>
            </div>
          )}
