...
- App root: `/Users/user01/Music/SEMForge-worktrees/phase-5-release/semforge`
...
| Privacy processor | `npx tsx --test src/server/privacy/processor.test.ts src/server/privacy/service.integration.test.ts` | Runtime processor revokes GSC refresh tokens, deletes private report objects, records hashed email suppression, and blocks local immutable report deletion if external processing fails. |
