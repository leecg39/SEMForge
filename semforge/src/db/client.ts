...
const globalForDb = globalThis as unknown as { __semforgeCloneDb?: DbClient };

function getConnection(): DbClient {
  if (!globalForDb.__semforgeCloneDb) {
    globalForDb.__semforgeCloneDb = createConnection();
  }
  return globalForDb.__semforgeCloneDb;
}
