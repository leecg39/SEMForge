...
const EN_TO_KO: Record<string, string> = {
  ...
  "TRY SEMFORGE ONE FOR FREE": "SEMFORGE ONE 무료 체험",
  ...
  "Digital PR": "디지털 PR",
  "Rank Tracking": "포지션 추적",
  "Marketing Reports": "마케팅 보고서",
  "See all features": "모든 기능 보기",
  "Connect SEMForge MCP to AI": "SEMForge MCP를 AI에 연결하세요",
  ...
  "Data-driven strategies": "데이터 기반 전략",
  "Turn data into direction": "데이터를 방향으로 바꾸세요",
  "Start free now": "지금 무료로 시작하기",
  "Use cases": "사용 사례",
  ...
  "Grow with SEMForge": "SEMForge와 함께 성장하기",
  ...
  Support: "지원",
  Community: "커뮤니티",
  "SEMForge Blog": "SEMForge 블로그",
  "Ambassador Program": "앰배서더 프로그램",
  Legal: "법률",
  "Privacy Policy": "개인정보처리방침",
  "Terms of Service": "서비스 약관",
  "Cookies Settings": "쿠키 설정",
  "GET STARTED WITH SEMFORGE TODAY": "오늘 SEMFORGE를 시작하세요",
  "Try SEMForge free for seven days. Cancel anytime.":
    "SEMForge를 7일 동안 무료로 체험하세요. 언제든 취소할 수 있습니다.",
  "Start free trial": "무료 체험 시작",
  "All rights reserved.": "모든 권리 보유.",
  "SEMForge homepage": "SEMForge 홈페이지",
  Main: "주요 메뉴",
  ...
  "Link Building": "링크 구축",
  "AI Analysis": "AI 분석",
  "Visibility Overview": "가시성 개요",
  "Competitor Research": "경쟁사 리서치",
  "Prompt Research": "프롬프트 리서치",
  "Brand Performance": "브랜드 성과",
  Perception: "인식",
  "Narrative Drivers": "내러티브 드라이버",
  Questions: "질문",
  "Growth & Monitoring": "성장 및 모니터링",
  "Growth Actions": "성장 액션",
  "Prompt Tracking": "프롬프트 추적",
  Start: "시작",
  Overview: "개요",
  ...
  "My Apps": "내 앱",
  "Site Audit": "사이트 진단",
  "Technical Site Audit": "기술 사이트 진단",
  "Position Tracking": "포지션 추적",
  "Keyword Magic Tool": "키워드 매직 도구",
  "SEMForge One": "SEMForge One",
  "SEMForge Rank": "SEMForge Rank",
  "SEMForge Sensor": "SEMForge Sensor",
  "AI PR": "AI PR",
  Share: "공유",
