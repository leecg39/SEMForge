...
export const toolkitSlides = [
  { tag: "SEMFORGE ONE", title: "Grow your digital brand visibility", image: "/toolkits/semforge_one_m.svg", alt: "Visibility over time preview" },
...
export const aiVisibilityIndex = {
  ...
  cta: { label: "Explore the index", href: "/ext/ai-visibility-index.semforge.com/" },
...
export const resourcesSection = {
  ...
  cards: [
    ...
    { title: "New partnership brings search data into the builder", body: "Search intelligence integrated directly into the building experience for faster iteration.", tags: ["News", "Product Update"], image: "/images/resources/semforge_lovable_anouncement.svg", href: "/news/" },
    { title: "Strengthening enterprise brand visibility", body: "How brand visibility, SEO, and AI-driven customer experience come together at scale.", tags: ["News"], image: "/images/resources/adobe_semforge_announcement.svg", href: "/news/" },
    { title: "FAQ for customers", body: "Answers to the most important questions: what changes, what stays the same, and what to expect next.", tags: ["News"], image: "/images/resources/adobe_semforge_announcement_faq.svg", href: "/news/" },
