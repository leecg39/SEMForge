...
export const seoAnalysis: Record<string, AnalysisPageData> = {
  ...
  "/analytics/backlinks/overview/": analysis({ toolkit: "seo", href: "/analytics/backlinks/overview/", name: "Backlinks", desc: "Explore any domain's backlink profile.", chartTitle: "New vs lost backlinks", chartType: "area", tableTitle: "Backlinks" }),
