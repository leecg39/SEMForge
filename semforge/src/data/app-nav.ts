...
export const appToolkits: Record<string, AppToolkit> = {
  seo: {
    ...
    groups: [
      {
        heading: "Dashboard",
        tools: [{ label: "SEO Dashboard", href: "/seo/" }],
      },
      {
  ...
  traffic: {
    ...
    groups: [
      {
        heading: "Start",
        tools: [{ label: "Dashboard", href: "/analytics/traffic/" }],
      },
      {
        heading: "Overview",
        tools: [
  ...
  local: {
    ...
    groups: [
      {
        heading: "Dashboard",
        tools: [{ label: "Local Dashboard", href: "/local-business/" }],
      },
      {
        heading: "Management",
        tools: [
      ...
      {
        heading: "Automation",
        tools: [{ label: "GBP AI Agent", href: "/gbp-ai-agent/" }],
      },
      {
        heading: "Competitive Analysis",
        tools: [{ label: "Map Rank Tracker", href: "/map-rank-tracker/" }],
      },
    ],
  },
  content: {
    ...
    groups: [
      {
        tools: [
          { label: "Content Home", href: "/content/", icon: "home" },
          {
            label: "Workspaces",
            href: "/content/workspaces/",
            icon: "workspaces",
          },
  ...
  social: {
    ...
    groups: [
      {
        heading: "Dashboard",
        tools: [{ label: "Social Dashboard", href: "/social-media/" }],
      },
      {
        heading: "Core",
        tools: [
          { label: "Social Poster", href: "/social-media/poster/" },
          { label: "Social Tracker", href: "/social-media/tracker/" },
          {
            label: "Content Insights",
            href: "/social-media/content-insights/",
          },
          { label: "Social Analytics", href: "/social-media/analytics/" },
        ],
      },
      {
        heading: "Advanced",
  ...
  reports: {
    ...
    groups: [
      {
        heading: "Home",
        tools: [{ label: "My Reports", href: "/my_reports/grid/" }],
      },
      {
        heading: "Builder",
        tools: [
          ...
          {
            label: "Themes",
            href: "/my_reports/constructor?accordionTab=themes",
          },
        ],
      },
      {
        heading: "Info",
        tools: [{ label: "Reports suite", href: "/my_reports/suite" }],
      },
    ],
  },
};
