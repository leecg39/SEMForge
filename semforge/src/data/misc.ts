...
function detail(title: string, subtitle: string, eyebrow: string): DetailPageData {
  return {
    ...
    heroImage: "/toolkits/semforge_one_m.svg",
    benefits: [
...
export const detailLandings: Record<string, DetailPageData> = {
  one: detail("SEMForge One", "SEO and AI visibility unified in one platform, built on years of search intelligence.", "PRODUCT"),
  enterprise: detail("SEMForge Enterprise", "Brand visibility at scale for large organizations and complex teams.", "ENTERPRISE"),
  mcp: detail("SEMForge MCP", "Bring live SEMForge data into your AI assistants through the Model Context Protocol.", "PRODUCT"),
  ...
  "free-trial": detail("Start your free trial", "Try the full platform free for seven days. Cancel anytime.", "FREE TRIAL"),
  ...
  "lp/semforge-circle": detail("Ambassador Program", "Join our community program and grow with fellow marketers.", "COMMUNITY"),
};
...
function comparison(competitor: string): DetailPageData {
  return {
    ...
    faqs: [
      { q: `Why choose SEMForge over ${competitor}?`, a: `This is a representative comparison highlighting data coverage, toolkits, and reporting versus ${competitor}.` },
...
export const vsData: Record<string, DetailPageData> = {
  "semforge-vs-moz": comparison("Moz"),
  "semforge-vs-ahrefs": comparison("Ahrefs"),
};
...
export const apiDocs: Record<string, ContentDetailData> = {
  ...
  bot: apiDoc("SEMForge Bot", "How our crawler works and how to manage its access to your site."),
};
