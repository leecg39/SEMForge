...
const toolkits = [
  { label: "SEMForge One", href: "/pricing/semforge-one/" },
...
export const pricingData: Record<string, PricingPageData> = {
  "semforge-one": make("semforge-one", "SEMForge One pricing", 99),
...
export const pricingHub: PricingPageData = {
  ...
  subtitle: "Pick the toolkit you need, or get everything with SEMForge One.",
};
