...
export default function CookieConsentModal() {
  const localizedCategories = useLocalizedValue(categories);
    ...
    <div className="fixed inset-0 z-[600] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[560px] rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <p className="mt-2 text-[14px] text-[#6c6e79]">
          {tx("Manage how this site uses cookies. This is a representative consent dialog.")}
        </p>
        <div className="mt-6 space-y-4">
          {localizedCategories.map((c, i) => (
